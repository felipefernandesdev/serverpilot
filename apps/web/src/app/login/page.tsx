      ...
      <div className="w-full max-w-md p-8">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">SitePanel</h1>
            <p className="text-gray-500 mt-1">Client Control Panel</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-xs text-gray-600">Username: client01</p>
            <p className="text-xs text-gray-600">Password: client123</p>
          </div>
        </div>
      </div>
    </div>
